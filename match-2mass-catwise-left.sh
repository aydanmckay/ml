...
outfile=/arc/home/aydanmckay/pristine-2mass-catwise-left.fits
...
${stilts} tmatch2 \
        ...
        in2=${catwise} \
        icmd2="keepcols 'RA(CaHK) Dec(CaHK) pmRA pmDE e_pmRA e_pmDE W1mproPM e_W1mproPM W2mproPM e_W2mproPM angDist'" \
